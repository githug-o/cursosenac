<html>
    ...
    <!-- Inicio do formulario -->
      <form method="post" action="{{route('criar')}}">
        ...
        <input class="form-control" name="nome" type="text" id="nome" size="60" /></label><br />
        <label class="form-label">E-mail:
        <input class="form-control" name="email" type="text" id="email" size="60" /></label><br />
        <label class="form-label" class="form-label">Telefone:
        <input class="form-control" name="telefone" type="text" id="telefone" size="60" /></label><br />
        <br>
        ...
        <input class="form-control" name="numero" type="text" id="numero" size="8" /></label><br />
        <label class="form-label">Complemento:
        <input class="form-control" name="complemento" type="text" id="complemento" size="8" /></label><br />
